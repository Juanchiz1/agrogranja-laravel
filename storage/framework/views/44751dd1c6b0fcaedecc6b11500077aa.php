...
<div class="header">
  <h1>Reporte General <?php echo e($anio); ?></h1>
  <p><?php echo e($usuario->nombre_finca ?? 'Mi Finca'); ?> · <?php echo e($usuario->departamento ?? ''); ?><?php echo e($usuario->municipio ? ', '.$usuario->municipio : ''); ?></p>
  <p style="margin-top:6px;font-size:10px;">Generado el <?php echo e(now()->format('d/m/Y \a \l\a\s H:i')); ?></p>
</div>

<div class="balance <?php echo e($balance >= 0 ? 'positivo' : 'negativo'); ?>" style="margin-top:16px;">
  <div class="valor" style="color:<?php echo e($balance >= 0 ? '#3d8b3d' : '#dc2626'); ?>">
    $<?php echo e(number_format(abs($balance),0,',','.')); ?>

  </div>
  <div class="label">Balance <?php echo e($anio); ?> — <?php echo e($balance >= 0 ? 'Ganancia' : 'Perdida'); ?></div>
</div>

<div class="grid">
  <div class="card card-green">
    <div class="val" style="color:#3d8b3d">$<?php echo e(number_format($totalIngresos/1000,0)); ?>k</div>
    <div class="lbl">Ingresos</div>
  </div>
  <div class="card card-brown">
    <div class="val" style="color:#7a4f2a">$<?php echo e(number_format($totalGastos/1000,0)); ?>k</div>
    <div class="lbl">Gastos</div>
  </div>
  <div class="card card-green">
    <div class="val" style="color:#3d8b3d">$<?php echo e(number_format($totalCosechas/1000,0)); ?>k</div>
    <div class="lbl">Val. cosechas</div>
  </div>
  <div class="card card-blue">
    <div class="val" style="color:#2563eb"><?php echo e($cultivos->count()); ?></div>
  ...
  <table class="month-table">
    ...
    <tbody>
      ...
      <tr style="background:#f8f5ee;">
        ...
        <?php for($m=1;$m<=12;$m++): ?>
        <?php $bal = ($ingresosMes[$m]??0) - ($gastosMes[$m]??0); ?>
        <td class="<?php echo e($bal >= 0 ? 'pos' : 'neg'); ?>">$<?php echo e(number_format($bal/1000,0)); ?>k</td>
        <?php endfor; ?>
      </tr>
    </tbody>
  </table>
...
</html><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Sem Investigacion\agrogranja-laravel\resources\views/exports/reporte-general-pdf.blade.php ENDPATH**/ ?>