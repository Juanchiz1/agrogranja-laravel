...
<?php $__env->startSection('title','Piscicola'); ?>
<?php $__env->startSection('page_title','Piscicola'); ?>
...
<div class="pisc-stats">
  <div class="pisc-stat">
    ...
    <div class="pisc-stat-val"><?php echo e($totalEstanques); ?></div>
    <div class="pisc-stat-lbl">Estanques</div>
  </div>
  <div class="pisc-stat verde">
    <div class="pisc-stat-ico">&#9989;</div>
    <div class="pisc-stat-val"><?php echo e($totalActivos); ?></div>
    <div class="pisc-stat-lbl">En produccion</div>
  </div>
  <div class="pisc-stat">
    <div class="pisc-stat-ico">&#9618;</div>
    <div class="pisc-stat-val"><?php echo e(number_format($totalAreaM2, 0)); ?> m2</div>
    <div class="pisc-stat-lbl">Area activa</div>
  </div>
  <div class="pisc-stat naranja">
    <div class="pisc-stat-ico">&#9878;</div>
    <div class="pisc-stat-val"><?php echo e(number_format($totalBiomasa, 1)); ?> kg</div>
    <div class="pisc-stat-lbl">Biomasa total</div>
  </div>
</div>


<?php if($alertasAgua->count()): ?>
<div class="section-card">
  <div class="section-title" style="margin-bottom:8px;color:#dc2626;">
    Alertas de calidad del agua (<?php echo e($alertasAgua->count()); ?>)
  </div>
  <?php $__currentLoopData = $alertasAgua->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div class="alerta-pisc critica">
    <span>!</span>
    <div>
      <strong><?php echo e($a->nombre_estanque ?? 'Estanque'); ?></strong>
      — <?php echo e(\Carbon\Carbon::parse($a->fecha)->format('d/m/Y')); ?><br>
      <span style="font-size:.74rem;">
        <?php if(!empty($a->oxigeno_mgl)): ?>Oxigeno: <?php echo e($a->oxigeno_mgl); ?> mg/L <?php endif; ?>
        <?php if(!empty($a->ph)): ?> — pH: <?php echo e($a->ph); ?> <?php endif; ?>
        <?php if(!empty($a->temperatura_c)): ?> — Temp: <?php echo e($a->temperatura_c); ?> C <?php endif; ?>
      </span>
    </div>
    <a href="<?php echo e(route('piscicola.calidad_agua')); ?>"
...
<div class="section-card">
  <div class="section-header">
    <div class="section-title">Estanques (<?php echo e($totalEstanques); ?>)</div>
  ...
  <div class="estanque-card <?php echo e($estadoClass); ?>" style="margin-bottom:8px;">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;">
      <div>
        <div class="estanque-nombre"><?php echo e($est->nombre); ?></div>
        <div class="estanque-sub">
          <?php echo e($est->especie_cultivada ?? '—'); ?> &middot;
          <?php echo e($est->area_m2); ?> m2
          <?php if(!empty($est->profundidad_m)): ?>
          &middot; <?php echo e($est->profundidad_m); ?>m prof.
          <?php endif; ?>
          <?php if(!empty($est->ubicacion)): ?>
          &middot; <?php echo e($est->ubicacion); ?>

          <?php endif; ?>
        </div>
      </div>
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px;">
        <span class="estado-pisc <?php echo e($estadoClass); ?>"><?php echo e($est->estado); ?></span>
        <?php if($tieneAlerta): ?>
    ...
    <div style="margin-top:8px;border-top:1px solid #e2e8f0;padding-top:8px;">
      <div style="display:flex;justify-content:space-between;font-size:.78rem;margin-bottom:3px;">
        <span style="color:#64748b;">Dia <?php echo e($diasCultivo); ?> &mdash; <?php echo e($siembra->especie ?? '—'); ?></span>
        <span style="font-weight:700;color:#0ea5e9;"><?php echo e($biomasaActKg); ?> kg biomasa</span>
      </div>
      <div class="biomasa-barra-wrap">
        <div class="biomasa-barra-fill" style="width:<?php echo e(min(100,$pctBiomasa)); ?>%;"></div>
      </div>
      <div style="display:flex;justify-content:space-between;font-size:.72rem;color:#94a3b8;margin-top:2px;">
        <span><?php echo e(number_format($siembra->cantidad_actual ?? $siembra->cantidad_alevinos ?? 0)); ?> peces</span>
        <?php if($sobrevivencia !== null): ?>
        <span>Sobrevivencia: <strong style="color:<?php echo e($sobrevivencia >= 90 ? '#15803d' : ($sobrevivencia >= 75 ? '#b45309' : '#dc2626')); ?>;"><?php echo e($sobrevivencia); ?>%</strong></span>
        <?php endif; ?>
        <?php if(!empty($siembra->peso_promedio_actual_g)): ?>
        <span><?php echo e($siembra->peso_promedio_actual_g); ?>g/pez</span>
        <?php endif; ?>
      </div>
    </div>
    <?php else: ?>
    <div style="margin-top:6px;">
      <button onclick="openSiembra(<?php echo e($est->id); ?>,'<?php echo e(addslashes($est->nombre)); ?>','<?php echo e(addslashes($est->especie_cultivada ?? '')); ?>')"
    ...
    <div style="display:flex;gap:6px;margin-top:8px;flex-wrap:wrap;">
      <button onclick="openEditEstanque(<?php echo e($est->id); ?>,'<?php echo e(addslashes($est->nombre)); ?>',<?php echo e($est->area_m2); ?>,'<?php echo e(addslashes($est->especie_cultivada ?? '')); ?>','<?php echo e($est->estado); ?>')"
              class="btn btn-sm btn-ghost" style="font-size:.72rem;">Editar</button>
      <?php if($tieneSiembra): ?>
      <a href="<?php echo e(route('piscicola.alimentacion')); ?>" class="btn btn-sm btn-ghost" style="font-size:.72rem;">Alimentar</a>
      <a href="<?php echo e(route('piscicola.calidad_agua')); ?>" class="btn btn-sm btn-ghost" style="font-size:.72rem;">Agua</a>
      <a href="<?php echo e(route('piscicola.cosecha')); ?>" class="btn btn-sm btn-ghost" style="font-size:.72rem;">Cosechar</a>
      <?php endif; ?>
    </div>
  </div>
...
<div id="modalNuevoEstanque" class="modal-overlay" style="display:none;">
  <div class="modal-sheet">
    ...
    <form method="POST" action="<?php echo e(route('piscicola.estanques.store')); ?>">
      <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Juan Diego\Documents\Universidad Documentos clases\Sem Investigacion\agrogranja-laravel\resources\views/pages/piscicola/estanques.blade.php ENDPATH**/ ?>