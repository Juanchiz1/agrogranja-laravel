...
<div class="modal-overlay" id="editAnimal<?php echo e($a->id); ?>" style="display:none;">
  <div class="modal-sheet">
    ...
    <form method="POST" action="<?php echo e(route('animales.update', $a->id)); ?>" enctype="multipart/form-data">
      ...
      <?php if(in_array($a->especie, ['Cerdos','Cerdas de cría','Porcinos'])): ?>
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <select name="categoria_porcina" class="form-control">
              ...
              <option value="lechon"           <?php echo e(($a->categoria_porcina ?? '') === 'lechon'           ? 'selected' : ''); ?>>Lechon</option>
              <option value="levante"          <?php echo e(($a->categoria_porcina ?? '') === 'levante'          ? 'selected' : ''); ?>>Levante</option>
              <option value="ceba"             <?php echo e(($a->categoria_porcina ?? '') === 'ceba'             ? 'selected' : ''); ?>>Ceba</option>
              <option value="hembra_cria"      <?php echo e(($a->categoria_porcina ?? '') === 'hembra_cria'      ? 'selected' : ''); ?>>Hembra de cria</option>
              <option value="verraco"          <?php echo e(($a->categoria_porcina ?? '') === 'verraco'          ? 'selected' : ''); ?>>Verraco</option>
              <option value="vientre_descarte" <?php echo e(($a->categoria_porcina ?? '') === 'vientre_descarte' ? 'selected' : ''); ?>>Descarte</option>
            </select>
          </div>
          <div class="form-group">
            <label>Raza</label>
            <input type="text" name="raza_porcina" class="form-control"
                   value="<?php echo e($a->raza_porcina ?? ''); ?>"
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <input type="number" name="peso_entrada_kg" step="0.1" min="0"
                   class="form-control" value="<?php echo e($a->peso_entrada_kg ?? ''); ?>"
                   placeholder="Ej: 20">
          </div>
          <div class="form-group">
            <label>Meta sacrificio (kg)</label>
            <input type="number" name="peso_meta_sacrificio_kg" step="0.1" min="0"
                   class="form-control" value="<?php echo e($a->peso_meta_sacrificio_kg ?? 100); ?>"
                   placeholder="Ej: 100">
          </div>
        </div>
      </div>
