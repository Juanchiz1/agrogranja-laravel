...
<div class="modal-overlay" id="modalEditar" style="display:none;">
  <div class="modal-sheet"><div class="modal-handle"></div><h3 class="modal-title">✏️ Editar animal</h3>
    <form method="POST" action="<?php echo e(route('animales.update',$animal->id)); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
      ...
      <?php if(in_array($animal->especie, ['Ganado bovino','Terneros'])): ?>
        ...
        <div class="grid-2">
          ...
          <div class="form-group">
            ...
            <input type="text" name="padre_descripcion" class="form-control"
                   value="<?php echo e($animal->padre_descripcion ?? ''); ?>"
      ...
      <?php if(in_array($animal->especie, ['Gallinas','Patos','Pavos','Codornices','Aves de corral'])): ?>
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <select name="tipo_ave" class="form-control">
              ...
              <option <?php echo e(($animal->tipo_ave ?? '') === 'ponedora'        ? 'selected' : ''); ?> value="ponedora">🥚 Ponedora</option>
              <option <?php echo e(($animal->tipo_ave ?? '') === 'engorde'         ? 'selected' : ''); ?> value="engorde">🍗 Engorde</option>
              <option <?php echo e(($animal->tipo_ave ?? '') === 'doble_proposito' ? 'selected' : ''); ?> value="doble_proposito">🐔 Doble propósito</option>
              <option <?php echo e(($animal->tipo_ave ?? '') === 'reproductora'    ? 'selected' : ''); ?> value="reproductora">🐣 Reproductora</option>
              <option <?php echo e(($animal->tipo_ave ?? '') === 'pato'            ? 'selected' : ''); ?> value="pato">🦆 Pato</option>
              <option <?php echo e(($animal->tipo_ave ?? '') === 'pavo'            ? 'selected' : ''); ?> value="pavo">🦃 Pavo</option>
            </select>
          </div>
          <div class="form-group">
            <label>Línea genética</label>
            <input type="text" name="linea_ave" class="form-control"
                   value="<?php echo e($animal->linea_ave ?? ''); ?>"
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <input type="date" name="fecha_nacimiento_lote" class="form-control"
                   value="<?php echo e($animal->fecha_nacimiento_lote ?? ''); ?>">
          ...
          <div class="form-group">
            ...
            <input type="number" name="capacidad_galpon" class="form-control"
                   value="<?php echo e($animal->capacidad_galpon ?? ''); ?>"
      ...
      <?php if(in_array($animal->especie, ['Cerdos','Cerdas de cría','Porcinos'])): ?>
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <select name="categoria_porcina" class="form-control">
              <option value="">Sin categoría</option>
              <option <?php echo e(($animal->categoria_porcina ?? '') === 'lechon'           ? 'selected' : ''); ?> value="lechon">Lechón</option>
              <option <?php echo e(($animal->categoria_porcina ?? '') === 'levante'          ? 'selected' : ''); ?> value="levante">Levante</option>
              <option <?php echo e(($animal->categoria_porcina ?? '') === 'ceba'             ? 'selected' : ''); ?> value="ceba">Ceba</option>
              <option <?php echo e(($animal->categoria_porcina ?? '') === 'hembra_cria'      ? 'selected' : ''); ?> value="hembra_cria">Hembra de cría</option>
              <option <?php echo e(($animal->categoria_porcina ?? '') === 'verraco'          ? 'selected' : ''); ?> value="verraco">Verraco</option>
              <option <?php echo e(($animal->categoria_porcina ?? '') === 'vientre_descarte' ? 'selected' : ''); ?> value="vientre_descarte">Descarte</option>
            </select>
          </div>
          <div class="form-group">
            <label>Raza</label>
            <input type="text" name="raza_porcina" class="form-control"
                   value="<?php echo e($animal->raza_porcina ?? ''); ?>"
        ...
        <div class="grid-2">
          <div class="form-group">
            ...
            <input type="number" name="peso_entrada_kg" step="0.1" min="0"
                   class="form-control" value="<?php echo e($animal->peso_entrada_kg ?? ''); ?>"
                   placeholder="Ej: 20">
          </div>
          <div class="form-group">
            <label>Meta sacrificio (kg)</label>
            <input type="number" name="peso_meta_sacrificio_kg" step="0.1" min="0"
                   class="form-control" value="<?php echo e($animal->peso_meta_sacrificio_kg ?? 100); ?>"
                   placeholder="Ej: 100">
          </div>
        </div>
      </div>
