...
<!-- ══ HERO ══ -->
<section class="hero">
    <img src="{{ asset('img/logo-seedling-fondo-verde.svg') }}"
     alt="Agrogranja"
     class="hero-logo"
     width="250"
     height="250"
